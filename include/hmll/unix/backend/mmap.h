 ...
 * or copying. The returned iobuf holds a reference to the mmap (refcount incremented).
 * Call hmll_free_buffer on the view when done to decrement the refcount.
 *
 ...
 * @param out_view Output parameter for the view (ptr, size, and mmap_ref will be set)

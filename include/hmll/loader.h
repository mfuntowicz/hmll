...
struct hmll_loader
{
    ...
    void *backend_impl_;
    ssize_t(*fetch_range_impl_)(struct hmll *, int, const struct hmll_iobuf *, struct hmll_range);
    ssize_t(*fetchv_range_impl_)(struct hmll *, int, const struct hmll_iobuf *, const struct hmll_range *, size_t);
};

...
Along with the high-level, byte fetching, capabilities, it encapsulates the actual I/O method behind a consistent API
hiding away the actual platform-specific implementation and complexities for the user.

...
static ssize_t hmll_mmap_fetchv_range_impl(struct hmll *ctx, const int iofile,
...
struct hmll_error hmll_mmap_get_view(struct hmll *ctx, const int iofile,
